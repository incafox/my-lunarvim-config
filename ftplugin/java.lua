...
local config = {
  cmd = {
    -- "java",
    "/Users/abrahamhuaman/.sdkman/candidates/java/current/bin/java",
    ...
    "-jar",
    vim.fn.glob(home ..
      "/.local/share/lvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_1.6.600.v20231106-1826.jar"),
    "-configuration",
